...
from utils.signal_processors import create_thumbnail
...
class Entry(models.Model):
    ...
    INTERNAL_STATUS_CHOICES = (
        (INTERNAL_ARTICLE, _('Article')),
        (INTERNAL_OTHER, _('Other content')),
    )
    ...
    month = models.CharField(
        max_length=4, editable=False, blank=True, null=True)
    ...
    internal_status = models.IntegerField(
    ...
    def save(self, force_insert=False, force_update=False):
        ...
        # It's better to save this formatting once and save RAM by using more
        # disc
...
class Link(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.id and self.post_elsewhere:
            ...
            from django.utils.encoding import smart_str
            pydelicious.add(
                settings.DELICIOUS_USER, settings.DELICIOUS_PASSWORD,
...
post_save.connect(create_thumbnail, sender=Entry)
