...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.internal_status'
        db.add_column(u'core_entry', 'internal_status',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.internal_status'
        db.delete_column(u'core_entry', 'internal_status')
    ...
    models = {
        ...
        u'core.entry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_status': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
