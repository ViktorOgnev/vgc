...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.internal_status'
        db.alter_column(u'core_entry', 'internal_status', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Entry.internal_status'
        db.alter_column(u'core_entry', 'internal_status', self.gf('django.db.models.fields.IntegerField')())
