...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MenuItem.short_descr'
        db.add_column(u'menu_control_menuitem', 'short_descr',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MenuItem.short_descr'
        db.delete_column(u'menu_control_menuitem', 'short_descr')
